...
start:
    std::cout
        ...
        << "| [3] Network state & custom hms test                                                              |\n"
        ...
        << "| [i] Run manifold3 AI sample - request h.264 bitstream data, codec it and display it on pilot(DPK required; workflow demo only.)|\n"
